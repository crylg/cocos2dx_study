...
template<typename R>
void operator==(const VCallback<R ()>&,
	const VCallback<R ()>&);
template<typename R>
void operator!=(const VCallback<R ()>&,
	const VCallback<R ()>&);
...
template<typename R, typename P1>
void operator==(const VCallback<R (P1)>&,
	const VCallback<R (P1)>&);
template<typename R, typename P1>
void operator!=(const VCallback<R (P1)>&,
	const VCallback<R (P1)>&);
...
template<typename R, typename P1, typename P2>
void operator==(const VCallback<R (P1, P2)>&,
	const VCallback<R (P1, P2)>&);
template<typename R, typename P1, typename P2>
void operator!=(const VCallback<R (P1, P2)>&,
	const VCallback<R (P1, P2)>&);
...
template<typename R, typename P1, typename P2, typename P3>
void operator==(const VCallback<R (P1, P2, P3)>&,
	const VCallback<R (P1, P2, P3)>&);
template<typename R, typename P1, typename P2, typename P3>
void operator!=(const VCallback<R (P1, P2, P3)>&,
	const VCallback<R (P1, P2, P3)>&);
...
template<typename R, typename P1, typename P2, typename P3,
	typename P4>
	void operator==(const VCallback<R (P1, P2, P3, P4)>&,
	const VCallback<R (P1, P2, P3, P4)>&);
template<typename R, typename P1, typename P2, typename P3,
	typename P4>
	void operator!=(const VCallback<R (P1, P2, P3, P4)>&,
	const VCallback<R (P1, P2, P3, P4)>&);
...
template<typename R, typename P1, typename P2, typename P3,
	typename P4, typename P5>
	void operator==(const VCallback<R (P1, P2, P3, P4, P5)>&,
	const VCallback<R (P1, P2, P3, P4, P5)>&);
template<typename R, typename P1, typename P2, typename P3,
	typename P4, typename P5>
	void operator!=(const VCallback<R (P1, P2, P3, P4, P5)>&,
	const VCallback<R (P1, P2, P3, P4, P5)>&);
...
template<typename R, typename P1, typename P2, typename P3,
	typename P4, typename P5, typename P6>
	void operator==(const VCallback<R (P1, P2, P3, P4, P5, P6)>&,
	const VCallback<R (P1, P2, P3, P4, P5, P6)>&);
template<typename R, typename P1, typename P2, typename P3,
	typename P4, typename P5, typename P6>
	void operator!=(const VCallback<R (P1, P2, P3, P4, P5, P6)>&,
	const VCallback<R (P1, P2, P3, P4, P5, P6)>&);
...
#define VDELEGATE_MEMBER(Object, Method) (GetCallbackFactory(Method).Bind<Method>(Object))
...
public:
	...
	inline bool Find(const Delegate& f) const 
	{
		if (m_functors)
		{
			typename Container::const_iterator itr = std::find( m_functors->begin(),m_functors->end(),f );
			if (itr != m_functors->end())
			{
				return true;
			}
		}
	...
	inline void Remove(const Delegate& f)
	{
		if (m_functors)
		{
			typename Container::iterator itr = std::find( m_functors->begin(),m_functors->end(),f );
			if (itr != m_functors->end())
			{
				m_functors->erase(itr);
			}
			if (m_functors->empty())
			{
				delete m_functors;
	...
	inline void Call()
	{
		...
		{
			for (typename Container::iterator itr = m_functors.begin(); itr != m_functors.end(); ++itr)
			{
				(*itr)();
			}
		}
